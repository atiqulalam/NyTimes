package com.nytimes.data.remote.repository;
...
import com.nytimes.data.remote.ApiService;
import com.nytimes.data.remote.NetworkBoundResource;
import com.nytimes.data.remote.Resource;
import com.nytimes.data.remote.model.PopularArticleResponse;
import com.nytimes.view.callbacks.ResponseListener;
    ...
    public LiveData<Resource<List<ArticleEntity>>> loadPopularArticles(int howfarback) {
        return new NetworkBoundResource<List<ArticleEntity>, PopularArticleResponse>() {
            ...
            protected Call<PopularArticleResponse> createCall() {
                return apiService.loadPopularArticles(howfarback/*, "rJ6VQTbh1lAJwbKqNN5tMhUaGwKYJPCk"*/);
            }
        }.getAsLiveData();
    }
